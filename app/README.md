...
| 2 | 月次一覧 | `/` | トップページ。月ごとの収支データ一覧。追加・編集・削除・レシートスキャン・カテゴリ絞り込み |
| 3 | 月次グラフ | `/chart` | 収支バランス・貯蓄率・カテゴリ別円グラフ |
| 4 | 年次推移 | `/trend` | 年間合計（収入・支出・貯蓄率）と12ヶ月の収支推移・カテゴリトレンド |
